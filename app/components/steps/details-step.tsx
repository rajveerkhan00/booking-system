      ...
      <div className="lg:col-span-2">
        <div className="glass-card-elevated rounded-2xl p-8 animate-fade-in">
          <div className="mb-8">
            ...
            <p className="text-gray-600 ml-[52px]">Please provide the main driver's information for this rental</p>
          </div>
          ...
          <form className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {inputFields.map((field, index) => {
                ...
                return (
                  ...
                  >
                    <label className={`block text-sm font-semibold mb-2 transition-colors ${focusedField === field.key ? 'text-secondary' : 'text-gray-700'
                      }`}>
            ...
            {/* Agreement Checkbox */}
            <div className={`border-2 rounded-2xl p-5 transition-all duration-300 animate-fade-in ${rentalAgreement ? 'border-primary bg-primary/10 shadow-soft' : 'border-secondary/30 bg-secondary/10'
              }`}>
        ...
        {bookingData.selectedCar && (
          <div className="bg-gradient-to-br from-gray-50 to-gray-100/50 rounded-xl p-4 mb-4 border border-gray-100">
            <div className="flex items-center gap-3">
              ...
              />
              <div>
                <p className="font-bold text-gray-900">{bookingData.selectedCar.name}</p>
                <p className="text-gray-500 text-xs font-medium">{bookingData.selectedCar.category}</p>
              </div>
            </div>
          </div>
        )}
      ...
      <div className="border-t border-gray-200 pt-4">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between pt-3 border-t border-gray-100">
            ...
            <span className="font-bold text-gray-900 text-xl">{currencySymbol} {(carPrice + extrasTotal).toLocaleString()}</span>
          </div>
        </div>
      </div>

      {/* Trust indicators */}
      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-4 space-y-2.5 border border-blue-100">
        <div className="flex items-center gap-2.5 text-sm text-secondary-dark">
          <div className="icon-container icon-container-sm bg-blue-100 text-secondary rounded-lg">
